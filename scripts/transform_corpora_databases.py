...
(function() {{
    ...
    with PySaxonProcessor(license=False) as proc:
        ...
        try:
            ...
            full_page = f"<!DOCTYPE html><html lang='it'><head><meta charset='UTF-8'><link rel='stylesheet' href='../../css/style.css'><title>Corpora &amp; Databases</title></head><body>{header_html}<main>{output}</main>{footer_html}</body></html>"
